...
class AccountFragment : Fragment() {
    ...
    private fun setInitDate() {
        ...
        dateRangeButton.text = "За місяць"
    }
        ...
        user?.let {
            ...
            if (user!!.isEmailVerified){ //check if user email already verified
                ...
                verified.setOnClickListener {
                    Toast.makeText(this@AccountFragment.activity, "Верифіковано", Toast.LENGTH_LONG).show()
                }
            }else{
                ...
                notVerified.setOnClickListener {
                    user?.sendEmailVerification()?.addOnCompleteListener {
                        if (it.isSuccessful){
                            Toast.makeText(this@AccountFragment.activity, "Перевірте свою електронну пошту! (Включно зі спамом)", Toast.LENGTH_LONG).show()
                        }else{
    ...
    private fun setupBarChart() {
        ...
        val xAxisValue= arrayListOf<String>("","Витрати", "Дохід")
    ...
    private fun setupPieChart(){
        ...
        pieEntries.add(PieEntry(amountExpense.toFloat(), "Витрати"))
        pieEntries.add(PieEntry(amountIncome.toFloat(), "Дохід"))
