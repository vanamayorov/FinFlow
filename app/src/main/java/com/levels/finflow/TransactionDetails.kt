...
class TransactionDetails : AppCompatActivity() {
    ...
    private fun deleteData() {
        ...
        deleteData.setOnClickListener {
            alertBox.setTitle("Ви впевнені?")
            alertBox.setMessage("Ви хочете видалити цю транзакцію?")
            alertBox.setPositiveButton("Так") { _: DialogInterface, _: Int ->
                deleteRecord(
                    intent.getStringExtra("transactionID").toString()
                )
            }
            alertBox.setNegativeButton("Скасувати") { _: DialogInterface, _: Int -> }
            alertBox.show()
        }
    }
    ...
    private fun deleteRecord(transactionID: String) {
        ...
        if (uid != null) {
            ...
            mTask.addOnSuccessListener {
                Toast.makeText(this, "Дані про транзакцію видалено", Toast.LENGTH_LONG).show()
                finish()
    ...
    private fun openUpdateDialog(
        ...
        mDialog.setTitle("Оновлюється транзакція $title")
        ...
        btnUpdateData.setOnClickListener {
            ...
            Toast.makeText(applicationContext, "Дані транзакції оновлено!", Toast.LENGTH_LONG)
                .show()
